...
class ManifestProcessor {
  ...
  //  * `manifestFallback`: the object of a fallback manifest,
  //    if a valid manifest is not found.
  process (jsonText, manifestURL, docURL, manifestFallback) {
    let rawManifest = {};
    try {
...
console.log('>>>', manifestFallback);
    if (!('name' in rawManifest) && typeof manifestFallback === 'object') {
      rawManifest = manifestFallback;
    }
